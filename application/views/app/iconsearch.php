...
if($icon_keyword){
    ...
    if(count($matching_results) > 0){
        ...
        foreach($matching_results as $count=>$en){
            ...
            echo '<td style="text-align: left;">'.view__cache(6177 /* Source Privacy */, $en['e__privacy'], true, 'right').' <span class="icon-block">'.view__cover($en['e__cover']).'</span><a href="'.view__memory(42903,42902).$en['e__handle'].'">'.$en['e__title'].'</a></td>';
            echo '</tr>';
