...
if ($_GET['focus__id']==12273 && superpower_unlocked(12700) && isset($_POST['s__id']) && isset($_POST['mass_action_toggle']) && isset($_POST['mass_value1_'.$_POST['mass_action_toggle']]) && isset($_POST['mass_value2_'.$_POST['mass_action_toggle']])) {
    ...
    //Process mass action:
    $process_mass_action = $this->Idea_model->mass_update($_POST['s__id'], intval($_POST['mass_action_toggle']), $_POST['mass_value1_'.$_POST['mass_action_toggle']], $_POST['mass_value2_'.$_POST['mass_action_toggle']], $player_e['e__id']);
    ...
    foreach($this->Idea_model->fetch(array('i__id' => $_POST['s__id'])) as $i){
    ...
    //Process mass action:
    $process_mass_action = $this->Source_model->mass_update($_POST['s__id'], intval($_POST['mass_action_toggle']), $_POST['mass_value1_'.$_POST['mass_action_toggle']], $_POST['mass_value2_'.$_POST['mass_action_toggle']], $player_e['e__id']);
    ...
    foreach($this->Source_model->fetch(array('e__id' => $_POST['s__id'])) as $e){
